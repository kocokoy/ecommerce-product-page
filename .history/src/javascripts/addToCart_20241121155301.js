...
export function createAddToCartButton(){
  const content = document.querySelector('.item-info');
...
function addtoCartCountUpdate(quantity){
  ...
  populateCart(cartContent,cart);
}

function populateCart(cartContent,cart){
  ...
  deleteButtonClicked(cartContent,cart);
}

function deleteButtonClicked(cartContent,cart){
